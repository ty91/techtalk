...
const ROW_COUNT = ROUND_1.length + 2
...
const CONTEXT_SPRING = { type: 'spring' as const, stiffness: 220, damping: 28 }

export function ContextEqualsInputSlide() {
  ...
  return (
    <SlideLayout title={'컨텍스트 = LLM의 입력'}>
      <div className="flex w-full max-w-6xl items-center justify-center gap-5">
        <div className="flex flex-1 justify-end">
          <motion.div
            layout
            transition={CONTEXT_SPRING}
            className="relative max-w-full rounded-2xl border-2 border-teal-400/60 bg-teal-500/5 px-3 py-3"
          >
